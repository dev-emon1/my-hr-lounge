import { Ban, CalendarClock, ShieldCheck, RotateCcw } from "lucide-react";

import { Card } from "@/shared/ui/card";

function SuspendedClientsStats() {
  const stats = [
    {
...
export default SuspendedClientsStats;
